...
export default {
    ...
    data(){
        return{
            manager:[
                "Public and strategic governance",
                "Business management",
                "Project/program management"
            ],
            techniques:[
               "Development infrastructure (water/energy/agriculture) ",
               "Land planning and natural resources management",
               "Hydrology, climate and sustainable development",
